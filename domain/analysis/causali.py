...
CAUSALI: dict[str, str] = {
    ...
    # la quadratura: il carico dichiarato contro quello erogato (L10)
    "workload_mismatch": ("{teacher}, {subject} su {unit}: ore dichiarate "
                          "dalla cattedra diverse da quelle erogate"),
